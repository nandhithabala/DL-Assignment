...
def prediction(indgred1,indgred2,indgred3,indgred4,indgred5,indgred6,indgred7,indgred8,indgred9,indgred10,indgred11,indgred12):  
    ingred=[[indgred1,indgred2,indgred3,indgred4,indgred5,indgred6,indgred7,indgred8,indgred9,indgred10,indgred11,indgred12]]
    model = tf.keras.models.load_model("C:\\Users\\siva\\Downloads\\Model.h5")
...
def main():
   ...
   # sample()
    if st.button("Predict"):
        result = prediction(indgred1,indgred2,indgred3,indgred4,indgred5,indgred6,indgred7,indgred8,indgred9,indgred10,indgred11,indgred12)
